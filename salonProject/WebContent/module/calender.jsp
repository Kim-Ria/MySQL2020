...
<head>
	...
	function selectDate(year, month, day){
		document.getElementById("lec_date").innerHTML = month+"월 "+day+"일";
		document.getElementById("lec_date_input").value = year+"-"+(month)+"-"+day;
	}
	</script>
</head>
<body>
...
%>
 <h3>
 <a href="index_academy.jsp?CONTENTPAGE=academy/reservation.jsp&n=0">&lt;&lt;</a>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <%=month+1 %>월 예약
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="index_academy.jsp?CONTENTPAGE=academy/reservation.jsp&n=1">&gt;&gt;</a>
 </h3>
