  ...
  <body>
    ...
    %>
      <div id="select_category">
        ...
        <input type="text" name="prod_name" accept-charset="utf-8" style="width:50px;">
	...
	<%
		...
		List<ProductBean> productList = pro.getProductList();
		
		if(request.getParameter("category") != null){
			productList = pro.getProductListCategory(Integer.parseInt(request.getParameter("category")));
	 	}
      ...
      <table border="0" align="center">
        ...
        <%
	      	for(int i=0; i<productList.size(); i++){
        		...
        		if(product.getStock()==0) stock = "품절";
    	%>
